...
Once the `conda-forge` channel has been enabled, `pyearth` can be installed with:

```
conda install pyearth
```

It is possible to list all of the versions of `pyearth` available on your platform with:
